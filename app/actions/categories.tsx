...
export async function addCategoryAction(values: Partial<ICategory>) {
  const result = await addCategoryService(values);
  revalidatePath('/admin/categories');
  return result;
}

export async function getAllCategoriesAction(searchParams: ISearchParams = {}) {
  return getAllCategoriesService(searchParams);
}
...
export async function updateCategoryAction(
  ...
  const result = await updateCategoryService(id, values);
  revalidatePath('/admin/categories');
  return result;
}

export async function getCategoryBySlugAction(slug: string) {
  return getCategoryBySlugService(slug);
}
