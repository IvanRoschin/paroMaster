...
import {
  ...
  getGoodTestimonialsService,
  getTestimonialByIdService,
  updateTestimonialService,
} from '../services/testimonialsService';

// ===== Actions =====
export async function addTestimonialAction(values: Partial<ITestimonial>) {
  const result = await addTestimonialService(values);
...
export async function getAllTestimonialsAction(
  ...
  return getAllTestimonialsService(searchParams);
}

export async function getTestimonialByIdAction(id: string) {
  return getTestimonialByIdService(id);
}
...
export async function updateTestimonialAction(
  ...
  const result = await updateTestimonialService(values);
  revalidatePath('/admin/testimonials');
  return result;
}

export async function getGoodTestimonialsAction(productId: string) {
  return getGoodTestimonialsService(productId);
}
...
// export async function getGoodTestimonials(
//   productId: string
