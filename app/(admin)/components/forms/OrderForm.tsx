...
// import { ICustomerSnapshot, IGoodUI, IOrder } from '@/types/index';
...
//   const [name, surname] = order?.customerSnapshot.name?.split(' ') || ['', ''];
...
//       phone: order?.customerSnapshot.phone || '+380',
