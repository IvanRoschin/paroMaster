...
export const mockGoods = [
  {
    ...
    src: ["https://picsum.photos/200/300?grayscale", "https://picsum.photos/200/300/?blur"],
    brand: "BrandA",
    model: "ModelX",
    vendor: "Vendor1",
  ...
  },
  {
    _id: "3g4h5i",
    category: "Furniture",
    src: ["https://picsum.photos/200/300", "https://picsum.photos/seed/picsum/200/300"],
    brand: "BrandC",
    model: "SofaMax",
    vendor: "Vendor3",
    title: "Sofa SofaMax",
  ...
  },
  {
    ...
    description: "Lightweight and powerful laptop for all your computing needs.",
    price: 1199.99,
    isAvailable: true,
    isCompatible: true,
