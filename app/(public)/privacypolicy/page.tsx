  ...
  return (
    <div className="bg-white text-black p-6">
      ...
      <Section title="§ 1 ОСНОВНІ ПОЛОЖЕННЯ">
        <p className="mb-2">
          1. Адміністратором персональних даних, зібраних через інтернет-магазин
          paromaster.com, є фізична особа – підприємець{' '}
          <strong>{process.env.NEXT_PUBLIC_ADMIN_NAME}</strong>, зареєстрований
          у Реєстрі юридичних осіб та фізичних осіб - підприємців запис №{' '}
      ...
      <Section title="§ 2 ТИПИ ОБРОБЛЮВАНИХ ПЕРСОНАЛЬНИХ ДАНИХ, ЦІЛІ ТА ОБСЯГ ЗБОРУ ДАНИХ">
        <p className="mb-2">
          <strong>Ціль обробки і правова основа:</strong> Адміністратор обробляє
          персональні дані Користувачів інтернет-магазину{' '}
          <strong>{process.env.NEXT_PUBLIC_SITE_NAME}</strong> у таких випадках:
        </p>
        <List
          items={[
        ...
        />
        <p className="mb-2">
          <strong>Види оброблюваних персональних даних:</strong> Користувач
      ...
      <Section title="§ 3 ПЕРЕДАЧА ПЕРСОНАЛЬНИХ ДАНИХ">
        <p className="mb-2">
          Персональні дані можуть бути передані наступним категоріям
          одержувачів:
        </p>
        <List
          items={[
