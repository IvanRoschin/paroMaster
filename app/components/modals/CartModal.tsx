...
const CartModal: React.FC<CartModalProps> = ({ isOpen }) => {
	...
	const { closeCart, openOrderModal, cartItems, resetCart } = useShoppingCart()
	...
	// 		.max(20)
	// 		.min(3)
	// 		.matches(nameRegex, { message: 'Тільки українські букви від 3 до 20 символів' })
	// 		.required(`Обов'язкове поле`),
	// 	email: Yup.string()
	// 		.max(63)
	// 		.min(3)
	// 		.matches(emailRegex, { message: 'Має включати @, від 3 до 63 символів' })
	// 		.required(`Обов'язкове поле`),
	// 	phone: Yup.string()
