...
const ItemListCard = ({ item }: ItemListCardProps) => {
  return (
    <li className="border border-gray-300 rounded-md p-4 flex flex-col">
      <Image
        src={ItemImg}
        alt="item_photo"
        width={150}
      ...
      <button
        type="button"
        className="p-4 mb-[20px] bg-orange-600 hover:bg-orange-700 focus:bg-orange-700 text-white transition-all font-semibold text-lg"
      >
        Купити
      </button>
