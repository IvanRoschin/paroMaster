...
export default function Item({ params }: { params: any }) {
  ...
  // Fetch reviews (assuming you have an endpoint for that)
  useEffect(() => {
    if (data) {
      // Replace this with actual API to fetch reviews
  ...
  return (
    <div className="flex flex-col lg:flex-row mb-4 lg:mb-0">
      ...
      <div className="pt-10 relative">
        ...
        {/* Display reviews */}
        <div className="mt-6">
          <h3 className="font-semibold text-xl">Відгуки:</h3>
          {reviews.length > 0 ? (
      ...
      <TestimonialModal isOpen={isModalOpen} closeModal={() => setIsModalOpen(false)} />
    </div>
  )
}
