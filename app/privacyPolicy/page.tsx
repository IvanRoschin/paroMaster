		...
		<div className='bg-white text-black p-6'>
			...
			<section className='mb-8'>
				...
				<ul className='list-disc list-inside mb-2'>
					...
					<li>при використанні Системи відгуків для отримання зворотного зв'язку від Клієнта;</li>
				...
				<ul className='list-disc list-inside mb-2'>
					<li>
						Для облікового запису: ім'я, прізвище, ім'я користувача, адреса, адреса електронної
						пошти.
					</li>
					<li>Для замовлень: ім'я, прізвище, адреса, адреса електронної пошти, номер телефону.</li>
			...
			<section className='mb-8'>
				...
				<ul className='list-disc list-inside mb-2'>
					<li>
						транспортним компаніям та кур'єрським службам, які співпрацюють з Адміністратором для
						доставки Замовлень,
					</li>
